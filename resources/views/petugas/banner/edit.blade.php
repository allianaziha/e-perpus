    ...
    <div class="row">
        <div class="col">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('petugas.banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('petugas.banner.index') }}" class="btn btn-sm btn-secondary">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
