        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="{{ route('petugas.buku.index') }}" class="btn btn-sm btn-outline-secondary">Kembali</a>
                    <a href="{{ route('petugas.buku.edit', $buku->id) }}" class="btn btn-sm btn-outline-warning">Edit</a>
                </div>
            </div>
        </div>
    </div>
