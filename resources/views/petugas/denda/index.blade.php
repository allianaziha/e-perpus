        ...
        <div class="col">
            <div class="card">
                <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('petugas.denda.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <tbody>
                                @foreach($dendas as $index => $data)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('petugas.denda.show', $data->id) }}" class="btn btn-sm btn-info" title="Detail"><i class="ti ti-eye"></i></a>
                                            <a href="{{ route('petugas.denda.edit', $data->id) }}" class="btn btn-sm btn-warning" title="Edit"><i class="ti ti-pencil"></i></a>
                                            <form action="{{ route('petugas.denda.destroy', $data->id) }}" method="POST" style="display:inline-block;">
                                                @csrf
                                                @method('DELETE')
