                            ...
                            <tbody>
                                @foreach ($peminjaman as $index => $data)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('petugas.peminjaman.show', $data->id) }}" class="btn btn-sm btn-info" title="Detail"><i class="ti ti-eye"></i></a>
                                            <a href="{{ route('petugas.peminjaman.edit', $data->id) }}" class="btn btn-sm btn-warning" title="Edit"><i class="ti ti-pencil"></i></a>
                                            <form action="{{ route('petugas.peminjaman.destroy', $data->id) }}" method="POST" style="display:inline-block;">
                                                @csrf
                                                @method('DELETE')
