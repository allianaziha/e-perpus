...
@section ('title', 'Petugas perpus - Perpanjangan Peminjaman')
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <a href="{{ route('petugas.perpanjangan.index', ['status' => 'pending']) }}"
                               class="btn btn-outline-warning btn-sm {{ request('status') == 'pending' ? 'active' : '' }}">
                                Menunggu
                            </a>
                            <a href="{{ route('petugas.perpanjangan.index', ['status' => 'approved']) }}"
                               class="btn btn-outline-success btn-sm {{ request('status') == 'approved' ? 'active' : '' }}">
                                Disetujui
                            </a>
                            <a href="{{ route('petugas.perpanjangan.index', ['status' => 'rejected']) }}"
                                    ...
                                    @foreach($perpanjangans as $index => $perpanjangan)
                                        <tr>
                                            ...
                                            <td class="text-center action-buttons">
                                                <a href="{{ route('petugas.perpanjangan.show', $perpanjangan) }}"
                                                   class="btn btn-info btn-sm">
                                                    <i class="ti ti-eye"></i>
                                                </a>
                                                @if($perpanjangan->status == 'pending')
                                                    <form action="{{ route('petugas.perpanjangan.approve', $perpanjangan) }}"
                                                    ...
                                                    <form action="{{ route('petugas.perpanjangan.reject', $perpanjangan) }}"
                                                          method="POST" class="d-inline"
