...
@section ('title', ' perpus - Detail Perpanjangan')
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
                ...
                <div class="card-body">
                    @if($perpanjangan->status == 'approved')
                        <div class="alert alert-success">
                            ...
                            <strong>Selamat!</strong> Request perpanjangan Anda telah disetujui.
                            Tanggal jatuh tempo peminjaman telah diperpanjang.
                        </div>
                    @elseif($perpanjangan->status == 'rejected')
                        <div class="alert alert-danger">
                            <i class="ti ti-x-circle"></i>
                            <strong>Maaf!</strong> Request perpanjangan Anda ditolak.
                        </div>
                    @else
                        <div class="alert alert-warning">
                            <i class="ti ti-clock-pause"></i>
                            <strong>Menunggu!</strong> Request perpanjangan Anda sedang diproses oleh admin/petugas.
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="card shadow mt-4">
                <div class="card-header bg-white">
                    <h5 class="mb-0">
                        <i class="ti ti-book text-success"></i> Informasi Buku
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
            ...
            <div class="card shadow mt-4">
                <div class="card-body text-center">
                    <a href="{{ route('user.perpanjangan.index') }}" class="btn btn-primary">
                        <i class="ti ti-arrow-left"></i> Kembali ke Daftar Perpanjangan
                    </a>
                </div>
            </div>
        </div>
